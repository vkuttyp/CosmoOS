...
**Forty-three, to 2026-09-20**, across CI and this developer's machine, on
...
Thirty-four entries, forty-three occurrences -- and the table is the tally,
...
them and are not independently re-verified here. The last twenty-nine rows
were watched as they happened: PR #167's carries the host's `accepted at
92.0s, 0 of 12 bytes`, and the **thirty-four instrumented** occurrences
behind the other twenty-eight rows carry the guest's side. Rows and

...
| `lockdep-rq-order` | after a migration attempt from 0 to 1 recorded `runqueue0 -> runqueue1`, taking 1 then 0 is reported as an inversion (S24 is a checked order) |

...
MODULES := hello virtio virtio_blk virtio_rng virtio_console virtio_net nvme e1000e xhci usb_storage cosmotest cosmotest_dep cosmotest_fail
...
MODULE_nvme_SRCS           := drivers/nvme/nvme.c
...
MODULE_ARCHIVE_ENTRIES := \
	...
	modules/nvme.ko=$(MODULE_OUT)/nvme.ko \

...
bool selftest_vfs_mount_id(const char **reason);   /* chrdev per-open instances: open/release/read_file */   /* the last references of one vnode dropped from every CPU at once */

...
bool selftest_el2_vm_raise_spi(const char **reason);       /* an owner-side device's SPI goes through the distributor, gated by the guest's GIC */        /* a guest reads its feature registers, answered from the host and sanitized */
